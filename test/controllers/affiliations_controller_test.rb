...
class AffiliationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affiliation" do
    assert_difference('Affiliation.count') do
      post affiliations_url, params: { affiliation: { authorship_id: @affiliation.authorship_id, email: @affiliation.email, org_units_id: @affiliation.org_units_id } }
    end
  ...
  test "should update affiliation" do
    patch affiliation_url(@affiliation), params: { affiliation: { authorship_id: @affiliation.authorship_id, email: @affiliation.email, org_units_id: @affiliation.org_units_id } }
