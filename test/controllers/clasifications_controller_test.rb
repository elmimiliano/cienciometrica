...
class ClasificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clasification" do
    assert_difference('Clasification.count') do
      post clasifications_url, params: { clasification: { field: @clasification.field, system: @clasification.system } }
    end
  ...
  test "should update clasification" do
    patch clasification_url(@clasification), params: { clasification: { field: @clasification.field, system: @clasification.system } }
